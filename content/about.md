...
Hello there, I am Abhijit Paul, from a small village in India.

Here is a bit of backstory. I found programming by accident. I was in school, watching my teacher type something on screen that looked like complete gibberish. I asked what it was and how that code turned into a webpage. That question changed the rest of my life. I knew right then this was what I wanted to do.

I mostly work with React and React Native now, but the way I think about software goes deeper than the stack I use. I believe software should be responsive, light on resources, and fast even on low end systems. It's easy to reach for a library for every small problem, but I try to avoid that. Most of the time, the discomfort of writing something yourself is worth avoiding the bloat that comes with pulling in a dependency for something small.
...
If any of this resonates with you, feel free to check out my work or get in touch. I'm always happy to talk about code, movies, or good music.
